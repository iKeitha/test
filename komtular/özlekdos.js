...
Komutu Kullanmak İçin Öncelikle Ayarlarını Yapmalısınız
Bu Komutu Ayarlamak İçin \`a!rol-düzenle ${x}\` Yazınız
Tüm Komutları Görmek İçinde \`!arol-komutlar\` Komutunu Giriniz
Eğer Silmek İsterseniz \`!arol-komut-sil ${x}\`
`)
...
Bu Komutu Ayarlamak İçin \`a!rol-düzenle ${x}\` Yazınız
Tüm Komutları Görmek İçinde \`!arol-komutlar\` Komutunu Giriniz
Eğer Silmek İsterseniz \`a!rol-komut-sil ${x}\`
`)
